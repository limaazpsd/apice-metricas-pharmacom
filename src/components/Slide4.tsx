...
import {
  ...
  IMG_W, IMG_H, IMG_RADIUS, IMG_BORDER_FRONT, IMG_BORDER_BACK, IMG_SHADOW_FRONT, IMG_SHADOW_BACK,
} from './design';
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 48, flex: 1, minHeight: 0 }}>
          ...
          <div style={{ flexShrink: 0, width: 780, height: '100%', display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            {/* Top 3 card (highlighted) */}
            <div
              onMouseEnter={() => setHovered(0)} onMouseLeave={() => setHovered(null)}
              style={{ ...cardBase(0, 'highlight'), flex: '0 0 auto', padding: '24px 28px' }}
            >
            ...
            {/* Bottom 2 cards (fills remaining height) */}
            <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
              {/* Foco de Entrega */}
              <div
                onMouseEnter={() => setHovered(1)} onMouseLeave={() => setHovered(null)}
                style={{ ...cardBase(1), padding: '24px 28px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}
              >
                ...
                <p style={{ color: 'white', fontSize: 17, lineHeight: 1.6 }}>
                  Posts no Feed dominam com <strong style={{ color: '#60a5fa', fontSize: 26 }}>92,4%</strong> das visualizações.
                </p>
              </div>
              ...
              <div
                ...
                style={{ ...cardBase(2, 'red'), padding: '24px 28px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                ...
                <p style={{ color: 'white', fontSize: 17, lineHeight: 1.6 }}>
                  <strong style={{ color: '#f87171', fontSize: 26 }}>98,5%</strong> das views vêm de quem <strong>já segue</strong>. Alcance externo é ínfimo (1,5%).
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <img
              src="/metricas-reais/WhatsApp Image 2026-07-07 at 17.16.57 (2).jpeg"
              alt=""
              style={{
            ...
            />
            <img
              src="/metricas-reais/WhatsApp Image 2026-07-07 at 17.16.58 (1).jpeg"
              alt=""
              style={{
